...
class MCP320x:
    ...
    def __init__(self, CS_bar_pin, CLK_pin=1000000, MOSI_pin=0, MISO_pin=0,chip='MCP3208',
        ...
        self._Vref = 3.3
        self._values = self.my_values(self.ReadADC, self._ChannelMax)
        self._volts  = self.my_values(self.ReadVolts, self._ChannelMax)
    ...
    def ReadADC(self, channel):
        ...
        if self._MOSI == 0:
            ...
            self.SendBit(self._SingleEnded)   # Select single or differential
    ...
    def FastReadADC0(self):
        """his reads the actual ADC value of channel 0, with as little overhead as possible.
